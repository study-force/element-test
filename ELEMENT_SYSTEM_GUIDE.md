...
### 결과 화면 예시
![불의 정복자 결과](./images/result_fire_full.png)
...
![친구 공유](./images/share_friend.png)

#### 유형 비교 (VS)
> 친구와 나의 유형을 비교하여 공통점과 차이점을 자동 분석합니다.

![유형 비교 VS](./images/compare_vs.png)

![비교 결과](./images/compare_result.png)

#### 이미지 저장 (카드 / 전문 선택)
> 결과를 이미지로 저장할 때, **유형 카드**(캐릭터+성향바+강점/약점 요약)와 **내용 전체**(해석 섹션 포함 전문)를 선택할 수 있습니다.

![카드형 저장](./images/result_fire_card.png)

#### TQ 테스트 연계
> 1단계 검사 완료 후, 2단계 TQ 독해역량 검사로 자연스럽게 유도합니다. TQ 결과 예시를 5가지 유형(최상위~최하위)으로 자동 슬라이드하여 보여주며, PolarArea 차트로 독해역량 5축을 시각화합니다.

![TQ 연계 CTA](./images/cta_tq.png)

![TQ 결과 프리뷰](./images/tq_preview.png)
