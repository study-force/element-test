...
#### 이미지 저장 (카드 / 전문 선택)
> 결과를 이미지로 저장할 때, **유형 카드**(캐릭터+성향바+강점/약점 요약)와 **내용 전체**(해석 섹션 포함 전문) 중 선택하여 저장할 수 있습니다.

| 카드형 (요약) | 전문 (전체) |
|:---:|:---:|
| <img src="./images/result_fire_card.png" width="280" /> | <img src="./images/result_fire_full.png" width="280" /> |
...
| CTA 영역 | TQ 결과 프리뷰 |
|:---:|:---:|
| <img src="./images/cta_tq.png" width="320" /> | <img src="./images/tq_preview.png" width="320" /> |
